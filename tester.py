...
import psycopg2
import sys
import parallel_sort_join as parallel
...
if __name__ == '__main__':
	...
	parallel.ParallelSort('ratings', 'Rating', 'parallelSortOutputTable', con);
	...
	parallel.ParallelJoin('ratings', 'movies', 'MovieId', 'MovieId1', 'parallelJoinOutputTable', con);
	a = raw_input("Check in database and once you are done, press enter to delete all tables: ");
	deleteTables('ALL', con);
